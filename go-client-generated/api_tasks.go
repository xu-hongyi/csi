...
/*
TasksApiService 任务结束处理
任务结束处理
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param taskId 处理task任务id
 * @param action 处理task任务动作

@return AsyncTaskResponseView
*/
func (a *TasksApiService) ApiV1TasksTaskIdActionPost(ctx context.Context, taskId string, action string) (AsyncTaskResponseView, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/tasks/{task_id}/{action}"
